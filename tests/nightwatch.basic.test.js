...
module.exports = {
  ...
  "grab all the input tags with type of text and return in json format":
    function (browser) {
      browser
        .url("https://www.oneyoungworld.com/")
  ...
  // gets the value of a tag. If you just wanted text content, use getText(). Note that getValue() if used on a form input, it could grab the name of the inpuit field and return the user value.
  "Grab the inner text content of h1 tag": function (browser) {
    browser
      .url("https://www.oneyoungworld.com/")
      .getValue("h1", (resultText) => {
